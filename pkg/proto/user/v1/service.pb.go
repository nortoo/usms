...
const file_pkg_proto_user_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x1fpkg/proto/user/v1/service.proto\x12\x13nortoo.usms.user.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fpkg/proto/user/v1/message.proto2\x99\a\n" +
	"\aService\x12C\n" +
	...
	"\fRefreshToken\x12$.nortoo.usms.user.v1.RefreshTokenReq\x1a%.nortoo.usms.user.v1.RefreshTokenResp\x12p\n" +
...
var file_pkg_proto_user_v1_service_proto_goTypes = []any{
	...
	(*RefreshTokenReq)(nil),         // 10: nortoo.usms.user.v1.RefreshTokenReq
...
var file_pkg_proto_user_v1_service_proto_depIdxs = []int32{
	...
	10, // 10: nortoo.usms.user.v1.Service.RefreshToken:input_type -> nortoo.usms.user.v1.RefreshTokenReq
	...
	17, // 22: nortoo.usms.user.v1.Service.RefreshToken:output_type -> nortoo.usms.user.v1.RefreshTokenResp
