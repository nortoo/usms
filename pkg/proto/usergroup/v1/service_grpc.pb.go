...
const (
	Service_Create_FullMethodName = "/nortoo.usms.usergroup.v1.Service/Create"
	Service_Delete_FullMethodName = "/nortoo.usms.usergroup.v1.Service/Delete"
	Service_Update_FullMethodName = "/nortoo.usms.usergroup.v1.Service/Update"
	Service_Get_FullMethodName    = "/nortoo.usms.usergroup.v1.Service/Get"
	Service_List_FullMethodName   = "/nortoo.usms.usergroup.v1.Service/List"
)
...
type ServiceClient interface {
	Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*Group, error)
	Delete(ctx context.Context, in *DeleteReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*Group, error)
	Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*Group, error)
...
func (c *serviceClient) Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*Group, error) {
...
func (c *serviceClient) Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*Group, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Group)
...
func (c *serviceClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*Group, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Group)
...
type ServiceServer interface {
	Create(context.Context, *CreateReq) (*Group, error)
	Delete(context.Context, *DeleteReq) (*emptypb.Empty, error)
	Update(context.Context, *UpdateReq) (*Group, error)
	Get(context.Context, *GetReq) (*Group, error)
...
func (UnimplementedServiceServer) Create(context.Context, *CreateReq) (*Group, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedServiceServer) Delete(context.Context, *DeleteReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedServiceServer) Update(context.Context, *UpdateReq) (*Group, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedServiceServer) Get(context.Context, *GetReq) (*Group, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nortoo.usms.usergroup.v1.Service",
	...
	Metadata: "pkg/proto/usergroup/v1/service.proto",
}
