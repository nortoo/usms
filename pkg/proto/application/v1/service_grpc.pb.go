...
const (
	Service_Create_FullMethodName = "/nortoo.usms.application.v1.Service/Create"
	Service_Delete_FullMethodName = "/nortoo.usms.application.v1.Service/Delete"
	Service_Update_FullMethodName = "/nortoo.usms.application.v1.Service/Update"
	Service_Get_FullMethodName    = "/nortoo.usms.application.v1.Service/Get"
	Service_List_FullMethodName   = "/nortoo.usms.application.v1.Service/List"
)
...
type ServiceClient interface {
	Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*Application, error)
	Delete(ctx context.Context, in *DeleteReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*Application, error)
	Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*Application, error)
...
func (c *serviceClient) Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*Application, error) {
...
func (c *serviceClient) Update(ctx context.Context, in *UpdateReq, opts ...grpc.CallOption) (*Application, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Application)
...
func (c *serviceClient) Get(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*Application, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Application)
...
type ServiceServer interface {
	Create(context.Context, *CreateReq) (*Application, error)
	Delete(context.Context, *DeleteReq) (*emptypb.Empty, error)
	Update(context.Context, *UpdateReq) (*Application, error)
	Get(context.Context, *GetReq) (*Application, error)
...
func (UnimplementedServiceServer) Create(context.Context, *CreateReq) (*Application, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedServiceServer) Delete(context.Context, *DeleteReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedServiceServer) Update(context.Context, *UpdateReq) (*Application, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedServiceServer) Get(context.Context, *GetReq) (*Application, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nortoo.usms.application.v1.Service",
	...
	Metadata: "pkg/proto/application/v1/service.proto",
}
